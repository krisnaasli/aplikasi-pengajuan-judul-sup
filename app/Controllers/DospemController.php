...
class DospemController extends BaseController
{
    ...
    public function editProfil(): string
    {
        ...
        $data = array(
            'isi'    => 'dospem/editprofil', // View untuk form edit profil
    ...
    public function updateProfil()
    {
        ...
        return redirect()->to('/dashboard/dospem')->with('success', 'Profil berhasil diperbarui.');
    }

    public function daftarpengajuanJudul(): string
    {
        ...
        $data = [
            'title' => 'Daftar Pengajuan Judul',  // Judul halaman
            'isi'   => 'dospem/daftarpengajuanjudul', // Nama view untuk tampilan
    ...
    public function detailpengajuanJudul($id)
    {
        // Inisialisasi model
        $judulModel = new DaftarPengajuanJudulModel();
        ...
        $data = [
            ...
            'pengajuan' => $pengajuan,
            'isi'   => 'dospem/detailpengajuanjudul', // Nama view untuk tampilan
    ...
    public function updatePengajuanJudul($id)
    {
        $session = session();
        ...
        return redirect()->to('/daftar-pengajuan-judul/dospem')->with('success', 'Status pengajuan berhasil diperbarui.');
    }
