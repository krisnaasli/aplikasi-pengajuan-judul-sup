...
class DbsController extends BaseController
{
    public function index(): string
    {
        ...
        $data = array(
            ...
            'isi'   => 'dbs/dashboard', // View untuk dashboard dbs
        );
        return view('dbs/layouts/wrapper', $data);
    }
    ...
    public function editProfil(): string
    {
        ...
        $data = array(
            ...
            'isi'    => 'dbs/editprofil', // View untuk form edit profil
    ...
    public function updateProfil()
    {
        ...
        return redirect()->to('/dashboard/dbs')->with('success', 'Profil berhasil diperbarui.');
    }
    ...
    $data = [
        ...
        'isi'   => 'dbs/daftarpengajuanjudulfordospem', // Nama view untuk tampilan
    ...
    public function detailpengajuanJudulfordospem($id)
    {
        ...
        if (!$pengajuan) {
         ...
         // Ambil status message berdasarkan data pengajuan
        $statusMessage = $this->generateStatusMessage($pengajuan);
        ...
        $data = [
            ...
            'isi'   => 'dbs/detailpengajuanjudulfordospem', // Nama view untuk tampilan
    ...
    public function updatePengajuanJudulfordospem($id)
    {
        ...
        return redirect()->to('/daftar-pengajuan-judul/dosen-pembimbing')->with('success', 'Status pengajuan berhasil diperbarui.');
    }

    public function daftarpengajuanJudulfordbs(): string
    {
    ...
    // Ambil data pengajuan judul yang status_dospem1 dan status_dospem2 = 'approved'
    $pengajuanJudul = $judulModel->select('tbl_daftarpengajuanjudul.*, tbl_mahasiswa.nim, tbl_mahasiswa.program_studi, tbl_mahasiswa.jenjang')
    ->join('tbl_mahasiswa', 'tbl_mahasiswa.id = tbl_daftarpengajuanjudul.mahasiswa_id', 'inner')
    ->where('tbl_daftarpengajuanjudul.status_dospem1', 'approved') // Hanya yang status_dospem1 = 'approved'
    ->where('tbl_daftarpengajuanjudul.status_dospem2', 'approved') // Hanya yang status_dospem2 = 'approved'
    ...
    $data = [
        'title' => 'List Pengajuan Judul',  // Judul halaman
        'isi'   => 'dbs/daftarpengajuanjudulfordbs', // Nama view untuk tampilan
        'pengajuanJudul' => $pengajuanJudul,  // Data pengajuan judul yang diambil dari database
    ];
    ...
    public function detailpengajuanJudulfordbs($id)
    {
        // Inisialisasi model
        $judulModel = new DaftarPengajuanJudulModel();
        $mahasiswaModel = new MahasiswaModel();
        ...
        $data = [
            'title' => 'Detail Pengajuan Judul',
            'pengajuan' => $pengajuan,
            'isi'   => 'dbs/detailpengajuanjudulfordbs', // Nama view untuk tampilan
            'dosenPembimbing1' => $dosenPembimbing1,
            'dosenPembimbing2' => $dosenPembimbing2,
        ];
    ...
    public function updatePengajuanJudulfordbs($id)
    {
        $session = session();
        $userId = $session->get('id'); // ID pengguna dari tbl_users
       ...
       // Pastikan user yang login memiliki role 'dbs'
        if ($userRole !== 'dbs') {
        ...
        // Persiapkan data update untuk kolom status_dbs, komentar_dbs, dan timestamps_dbs
        $dataUpdate = [
            'status_dbs' => $status, // Set status_dbs
            'komentar_dbs' => $komentar, // Simpan komentar_dbs
            'timestamp_dbs' => $timestamp, // Set timestamp_dbs
        ];
        ...
        // Redirect kembali ke halaman daftar pengajuan
        return redirect()->to('/daftar-pengajuan-judul/dbs')->with('success', 'Status pengajuan berhasil diperbarui.');
    }
