...
<h1><?= esc($title) ?></h1>
<form action="<?= base_url('/daftar-pengajuan-judul/kaprodi/detail/' . $pengajuan['id']); ?>" method="post">
    <?= csrf_field() ?>
    <table class="table">
        <tr>
    ...
    <div class="form-group">
        ...
        <a href="<?= base_url('daftar-pengajuan-judul/kaprodi'); ?>" class="btn btn-secondary">Kembali</a>
    </div>
</form>
