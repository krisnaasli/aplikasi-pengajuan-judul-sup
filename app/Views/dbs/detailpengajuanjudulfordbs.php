<!-- app/Views/dbs/detailpengajuanjudulfordbs.php -->
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow-sm rounded-4">
                ...
                <div class="card-body">
                    <form action="<?= base_url('/daftar-pengajuan-judul/dbs/detail/' . $pengajuan['id']); ?>" method="post">
                        <?= csrf_field() ?>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <?php if ($pengajuan['ringkasan_file']): ?>
                                    <a href="<?= base_url('/daftar-pengajuan-judul/dbs/detail/uploads/ringkasan/' . $pengajuan['ringkasan_file']) ?>" target="_blank">Lihat Ringkasan</a>
                                <?php else: ?>
                                    Tidak ada file
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <?php if ($pengajuan['jurnal_file']): ?>
                                    <a href="<?= base_url('/daftar-pengajuan-judul/dbs/detail/uploads/jurnal/' . $pengajuan['jurnal_file']) ?>" target="_blank">Lihat Jurnal</a>
                                <?php else: ?>
                                    Tidak ada file
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="form-group row mb-4">
                            <div class="col-md-9 offset-md-3">
                                <a href="<?= base_url('daftar-pengajuan-judul/dosen-pembimbing'); ?>" class="btn btn-secondary btn-lg w-100">Kembali</a>
                            </div>
                        </div>
